...
exports.StyledContainer = styled_components_1.default(rebass_1.Flex)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
exports.StyledCross = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: absolute;\n  cursor: pointer;\n  top: 3.7rem;\n  right: 1.2rem;\n"], ["\n  position: absolute;\n  cursor: pointer;\n  top: 3.7rem;\n  right: 1.2rem;\n"])));
exports.InputField = function (_a) {
    var _b = _a.field, name = _b.name, onChange = _b.onChange, onBlur = _b.onBlur, field = __rest(_b, ["name", "onChange", "onBlur"]), _c = _a.form, touched = _c.touched, errors = _c.errors, values = _c.values, autocomplete = _a.autocomplete, placeholder = _a.placeholder, information = _a.information, flexDirection = _a.flexDirection, isDisabled = _a.isDisabled, isSmall = _a.isSmall, label = _a.label, type = _a.type, rest = __rest(_a, ["field", "form", "autocomplete", "placeholder", "information", "flexDirection", "isDisabled", "isSmall", "label", "type"]);
    var errorMsg = "";
    if (name) {
    ...
    return (React.createElement(exports.StyledContainer
    // @ts-ignore
    , __assign({ 
        // @ts-ignore
        ...
        React.createElement(rebass_1.Box, { width: flexDirection === "row" ? 2 / 3 : 1 },
            React.createElement(__1.Input, { type: type || "text", name: name, placeholder: placeholder, errors: !!errorMsg, onChange: onChange, onBlur: onBlur, autoComplete: autocomplete, value: formik_1.getIn(values, name) || "", isSmall: isSmall || false, disabled: isDisabled || false })),
