...
class InfoSeniorsApaHelpRequest extends Component {
  state = {
    value: "",
    suggestions: []
  };
    ...
    return (
      <div className="container">
        ...
        <div className="content final">
          <h1>
            Rendez-vous dans le point info 14 le plus proche de chez vous{" "}
          </h1>
          <Autosuggest
...
export default InfoSeniorsApaHelpRequest;
